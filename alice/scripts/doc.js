...
`;
  ...
  if (data.args.includes('bot')) return _bot.trim();
  else if (data.args.includes('commands')) return _commands.trim();
  else if (data.args.includes('cron')) return _cron.trim();
  else if (data.args.includes('dice')) return _dice.trim();
  else if (data.args.includes('doc')) return _doc.trim();
  else if (data.args.includes('github')) return _github.trim();
  else if (data.args.includes('links')) return _links.trim();
  else if (data.args.includes('lyric')) return _lyric.trim();
  else if (data.args.includes('report')) return _report.trim();
  else if (data.args.includes('search')) return _search.trim();
  else if (data.args.includes('suggest')) return _suggest.trim();
  else if (data.args.includes('wiki')) return _wiki.trim();
